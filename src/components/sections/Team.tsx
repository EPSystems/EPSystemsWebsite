...
// WebP variants generated by scripts/optimize-images.mjs (≤ 480 px wide).
const PHOTOS: Record<string, { src: string; position?: string }> = {
  member1: { src: '/team/emil.webp' },
  member2: { src: '/team/pavel.webp' },
  member3: { src: '/team/emi.webp' },
  member4: { src: '/team/yoana.webp', position: 'center 20%' },
}
