...
export function Contact() {
  ...
  const contactInfo = [
    {
      ...
      value: "engineering@epsystems.org",
      href: "mailto:engineering@epsystems.org",
    },
    {
      icon: Phone,
      labelKey: "contactPage.info.phone",
      value: "+359 879 503 151",
      href: "tel:+359879503151",
    },
  ...
  const faqItems = [
    {
      q: "contactPage.faq.items.0.question",
      a: "contactPage.faq.items.0.answer",
    },
    {
      q: "contactPage.faq.items.1.question",
      a: "contactPage.faq.items.1.answer",
    },
    {
      q: "contactPage.faq.items.2.question",
      a: "contactPage.faq.items.2.answer",
    },
    {
      q: "contactPage.faq.items.3.question",
      a: "contactPage.faq.items.3.answer",
    },
    {
      q: "contactPage.faq.items.4.question",
      a: "contactPage.faq.items.4.answer",
    },
  ];
                    ...
                    >
                      ...
                      <div className="mb-4">
                        ...
                        >
                          ...
                          <option value="web-development">
                            {t("contactForm.fields.service.options.webDev")}
                          </option>
                          <option value="ecommerce">
                            {t("contactForm.fields.service.options.ecommerce")}
                          </option>
                          <option value="seo">
                            {t("contactForm.fields.service.options.seo")}
                          </option>
                          <option value="ai-automation">
                            {t("contactForm.fields.service.options.ai")}
                          </option>
                          <option value="landing-page">
                            {t("contactForm.fields.service.options.landing")}
                          </option>
                          <option value="maintenance">
                            {t(
                              "contactForm.fields.service.options.maintenance",
                            )}
                          </option>
                          <option value="other">
                      ...
                      <div className="mb-4">
                        ...
                        >
                          ...
                          <option value="under-500">
                            {t("contactForm.fields.budget.options.under500")}
                          </option>
                          <option value="500-1500">
                            {t("contactForm.fields.budget.options.500to1500")}
                          </option>
                          <option value="1500-5000">
                            {t("contactForm.fields.budget.options.1500to5000")}
                          </option>
                          <option value="5000-plus">
                            {t("contactForm.fields.budget.options.5000plus")}
                          </option>
                          <option value="not-sure">
                            {t("contactForm.fields.budget.options.notSure")}
                          </option>
                        </select>
                      </div>
                      ...
                      <div className="mb-4">
                        ...
                        <textarea
                          rows={4}
                          placeholder={t(
                            "contactForm.fields.notes.placeholder",
                          )}
                          value={fields.notes}
              ...
              <div className="flex flex-col gap-8">
                <div>
                  ...
                  <div className="space-y-6">
                    {contactInfo.map(
                      ({ icon: Icon, labelKey, value, href }, i) => (
        ...
        <div className="max-w-7xl mx-auto px-6">
          <AnimatedSection>
            <h2 className="text-3xl lg:text-4xl font-black tracking-tighter text-center mb-8">
              {t("contactPage.calendly.heading", {
                defaultValue: "Or book a free 30-minute call",
              })}
            </h2>
