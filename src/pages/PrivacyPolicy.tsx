...
export function PrivacyPolicy() {
  ...
  const listClass = 'list-disc list-inside text-zinc-600 text-lg leading-relaxed mb-4 space-y-2'
  ...
  return (
    <>
      ...
      <main className="max-w-4xl mx-auto px-6 py-16 lg:py-24">
        ...
        <div className={sectionClass}>
          <h2 className={headingClass}>{t('privacy.sections.dataCollect.title')}</h2>
        ...
        <div className={sectionClass}>
          <h2 className={headingClass}>{t('privacy.sections.howWeUse.title')}</h2>
          <ul className={listClass}>
        ...
        <div className={sectionClass}>
          <h2 className={headingClass}>{t('privacy.sections.cookies.title')}</h2>
        ...
        <div className={sectionClass}>
          <h2 className={headingClass}>{t('privacy.sections.retention.title')}</h2>
          <ul className={listClass}>
        ...
        <div className={sectionClass}>
          <h2 className={headingClass}>{t('privacy.sections.contact.title')}</h2>
          <p className={textClass}>{t('privacy.sections.contact.text')}</p>
          <p className="text-lg font-bold text-black">privacy@epsystems.bg</p>
        </div>
      </main>
      <Footer />
    </>
